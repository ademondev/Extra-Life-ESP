...
translate spanish home_player_room_1ecd72f2:
    ...
    player "Agh... mi cabeza..." id home_player_room_1ecd72f2
...
translate spanish home_player_room_202ef4ac:
    ...
    player "¿Estoy en mi habitación? {w} Es como si nunca me hubiese marchado." id home_player_room_202ef4ac
...
translate spanish home_player_room_4c2a5a6c:
    ...
    player "Esto no puede ser real.{w} ¿Verdad?" id home_player_room_4c2a5a6c
...
translate spanish home_player_room_71ece9ec:
    ...
    player -sad "Pero soy un adolescente de nuevo..." id home_player_room_71ece9ec
...
translate spanish home_player_room_7a7db3e9:
    ...
    player "[year]!" id home_player_room_7a7db3e9
...
translate spanish home_player_room_284a0088:
    ...
    yasukac "{size=-4}Cariño, ¿Estas bien? ¿Tuviste una pesadilla?{/size}" id home_player_room_284a0088
...
translate spanish home_player_room_a0988271:
    ...
    player "¿Quizas mis oraciones fueron escuchadas?" id home_player_room_a0988271
...
translate spanish home_player_room_f900935d:
    ...
    player happy "¡Pero tengo que aprovechar todo esto y hacer lo mejor que pueda!" id home_player_room_f900935d
...
translate spanish home_player_room_5acfcd5f:
    ...
    x "Asi que para resumir todo..." id home_player_room_5acfcd5f
...
translate spanish home_player_room_86db6b79:
    ...
    x "¡Primero, el {color=#efdf31}{b}Parque{/b}{/color}, entonces el {color=#efdf31}{b}Restaurante{/b}{/color} y finalmente el {color=#efdf31}{b}Dojo{/b}{/color}!" id home_player_room_86db6b79
...
translate spanish home_player_room_62b2743c:
    ...
    x "¡Que perra!" id home_player_room_62b2743c
...
translate spanish home_player_room_a7b80dff:
    ...
    player "Mañana..." id home_player_room_a7b80dff
...
translate spanish home_player_room_3afd7d2c:
    ...
    player "¡Va a haber problemas!" id home_player_room_3afd7d2c
...
translate spanish home_player_room_45e10f61:
    ...
    x "Que noche" id home_player_room_45e10f61
...
translate spanish home_player_room_4a5f9199:
    ...
    x "¡¿Por qué tiene que dormir pegada a mi toda la noche?!" id home_player_room_4a5f9199
...
translate spanish home_player_room_87261a2b:
    ...
    player "Nada..." id home_player_room_87261a2b
...
translate spanish home_player_room_b71e31d7:
    ...
    x "No creo que {color=fd79a8}{b}[noriko_name]{/b}{/color} haya venido a mi habitación..." id home_player_room_b71e31d7
...
translate spanish home_player_room_8c443b7b:
    ...
    x "Quizas {color=#a29bfe}{b}[yasuka_name]{/b}{/color} sabe algo" id home_player_room_8c443b7b
...
translate spanish home_player_room_a7d9c0c3:
    ...
    x "Mejor que ir a la {color=#efdf31}{b}guarida del demonio...{/b}{/color}" id home_player_room_a7d9c0c3
...
translate spanish home_player_room_55b92307:
    ...
    player "Ah...demonios..." id home_player_room_55b92307
...
translate spanish home_player_room_3d76fd1f:
    ...
    player "¡Finalmente!" id home_player_room_3d76fd1f
...
translate spanish home_player_room_4b9737d5:
    ...
    player "¡Con suerte, podre evitar a {color=#fd79a8}{b}[noriko_name]{/b}{/color}!" id home_player_room_4b9737d5
...
translate spanish strings:
    ...
    new "Sal de la habitación y ve a ver a \n{color=a29bfe}{b}%s{/b}{/color} en la sala de estar."
    ...
    new "Preguntale a {color=#a29bfe}{b}%s{/b}{/color} para mas información"
    ...
    new "Pidele a {color=#fd79a8}{b}%s{/b}{/color} que se explique."
    ...
    new "¡¡Todo el mundo se ira a la mierda!!\nvoy a ir al {color=ffff00}{b}parque{/b}{/color}!"
