...
translate spanish dojo_exterior_292117b8:

    # player "wow ! Impressionnant..." id dojo_exterior_292117b8
    player "¡Wow! Impresionante..." id dojo_exterior_292117b8

# game/scripts/story/ancient district/dojo/dojo_exterior.rpy:58
translate spanish dojo_exterior_dd982f53:

    # player "Rien qu'à l'entrée, on est déjà bien dans l'ambiance." id dojo_exterior_dd982f53
    player "De simplemente mirarlo, puedes sentir el poder." id dojo_exterior_dd982f53
...
translate spanish dojo_exterior_e8e15207:
    ...
    akirac "¡PARA!" id dojo_exterior_e8e15207

# game/scripts/story/ancient district/dojo/dojo_exterior.rpy:62
translate spanish dojo_exterior_3cd69d40:

    # player -happy "...!?" id dojo_exterior_3cd69d40
    player -happy "¿¡..!?" id dojo_exterior_3cd69d40

# game/scripts/story/ancient district/dojo/dojo_exterior.rpy:67
translate spanish dojo_exterior_8214f5e8:

    # akira upset "N'espère même pas faire un seul pas de plus, déchet !" id dojo_exterior_8214f5e8
    akira upset "¡No des otro paso, basura!" id dojo_exterior_8214f5e8
...
translate spanish dojo_exterior_c9b0020c:
    ...
    akira "Dios, te ves como la mierda..." id dojo_exterior_c9b0020c

# game/scripts/story/ancient district/dojo/dojo_exterior.rpy:83
translate spanish dojo_exterior_113a5263:

    # x "Putain...{color=#fdcb6e}{b}[akira_name]{/b}{/color}... Je l'avais oublié celui-là..." id dojo_exterior_113a5263
    x "Mierda...{color=#fdcb6e}{b}[akira_name]{/b}{/color}... Me olvide de él..." id dojo_exterior_113a5263

# game/scripts/story/ancient district/dojo/dojo_exterior.rpy:84
...
translate spanish dojo_exterior_b3e9ba34:
    ...
    x "Siempre con sus insultos, humillaciones y violencia sin sentido..." id dojo_exterior_b3e9ba34
...
translate spanish dojo_exterior_3dca99e9:
    ...
    x "Mierda, esto no era parte del plan." id dojo_exterior_3dca99e9
...
# game/scripts/story/ancient district/dojo/dojo_exterior.rpy:111
...
# game/scripts/story/ancient district/dojo/dojo_exterior.rpy:114
...
translate spanish dojo_exterior_c8532248:
    ...
    # akira arrogant "Quel putain de cassos..." id dojo_exterior_c8532248
    akira arrogant "Que perdedor..." id dojo_exterior_c8532248
...
translate spanish dojo_exterior_873b55fb:
    ...
    x "No pude salir a correr esta mañana." id dojo_exterior_873b55fb

# game/scripts/story/ancient district/dojo/dojo_exterior.rpy:149
translate spanish dojo_exterior_2d3f3716:

    # x "Impossible de travailler." id dojo_exterior_2d3f3716
    x "No pude conseguir un trabajo." id dojo_exterior_2d3f3716

# game/scripts/story/ancient district/dojo/dojo_exterior.rpy:150
translate spanish dojo_exterior_2709905a:

    # x "Aucune chance d'accéder au dojo..." id dojo_exterior_2709905a
    x "Ni siquiera pude entrar en el dojo." id dojo_exterior_2709905a

# game/scripts/story/ancient district/dojo/dojo_exterior.rpy:151
translate spanish dojo_exterior_a21e86ee:

    # x "..." id dojo_exterior_a21e86ee
    x "..." id dojo_exterior_a21e86ee

# game/scripts/story/ancient district/dojo/dojo_exterior.rpy:152
